    ...
    blocks: [
      ...
      },
      {
        ...
        element: {
          ...
          options: [
            { text: { type: "plain_text", text: "💳 Payment affected", emoji: true },      description: { type: "plain_text", text: "Revenue Impact — payment / transaction bị lỗi" },          value: "payment" },
            { text: { type: "plain_text", text: "🗃️ Data integrity risk", emoji: true },   description: { type: "plain_text", text: "Data Integrity — mất / sai / corrupt data" },               value: "data_integrity" },
            { text: { type: "plain_text", text: "🔐 Login/Register broken", emoji: true }, description: { type: "plain_text", text: "User Acquisition — không đăng ký / đăng nhập được" },       value: "login_register" },
            { text: { type: "plain_text", text: "⚠️ Enterprise SLA breach", emoji: true }, description: { type: "plain_text", text: "Reputation — vi phạm SLA với khách hàng enterprise" },      value: "sla_breach" },
          ],
        },
      },
      {
        ...
        element: {
          ...
          options: [
            ...
            { text: { type: "plain_text", text: "🟡 High" },      description: { type: "plain_text", text: "Core feature broken, 5xx > 5%, p99 > 5s sustained" },                value: "degraded" },
